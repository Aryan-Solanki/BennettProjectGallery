...
Color argumentcolor= Colors.purple.shade900;
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: TextButton(
                    ...
                    child: Text("Community",style: TextStyle(
                        fontFamily: "Metrisch-Bold",fontSize: MediaQuery.of(context).size.height/35,color: texthovercolor)),
                  ),
                ),
                SizedBox(height: 10,),
                Padding(
                  padding:  EdgeInsets.symmetric(horizontal: 20.0),
                  child: Text("Get to know your fellow Bennatians and learn from their Projects",textAlign: TextAlign.left,style: TextStyle(
                    ...
                    children: [
                      ...
                      Text("Aryan Solanki",style: TextStyle(
                        ...
                        decorationColor: Colors.green,
                          ...
                          fontFamily: "Metrisch-Medium",height: 1.3, fontSize: MediaQuery.of(context).size.height/50,color: Colors.green))
                    ],
                  ),
                ),
                SizedBox(height: 10,),
                Padding(
                  padding:  EdgeInsets.symmetric(horizontal: 20.0),
                  child: Text("November 16, 2018 ",style: TextStyle(
                      fontFamily: "Metrisch-Medium",height: 1.3, fontSize: MediaQuery.of(context).size.height/50,color: Colors.black54)),
                ),
                SizedBox(height: 20,),
              ],
            ),
              ...
              child: Container(
                ...
                child: Text(
                  "PYTHON",style: TextStyle(
                    fontFamily: "Metrisch-Medium",height: 1.3, fontSize: MediaQuery.of(context).size.height/56,color: buttonhovercolor==argumentcolor?Colors.white:argumentcolor),
                ),
              ),
            ),
          )
