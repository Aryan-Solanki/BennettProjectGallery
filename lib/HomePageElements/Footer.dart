...
class _FooterState extends State<Footer> {
  ...
  Widget build(BuildContext context) {
    return MediaQuery.of(context).size.width>1220?Container(
      ...
      child: Padding(
        padding:EdgeInsets.only(top: 100,left: MediaQuery.of(context).size.width/20,right: MediaQuery.of(context).size.width/20),
        child: Expanded(
          child: Column(
            children: [
              Row(
                ...
                children: [
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Text("Lorem ipsum dolor sit amet consectetur adipisicing elit. Maxime mollitia,molestiae quas vel sint commodi repudiandae consequuntur voluptatum.",style: TextStyle(
                            fontFamily: "Metrisch-Medium",height: 1.8, fontSize: 15,color: Colors.white)),
                      ),
                      SizedBox(height: 20,),
                      Row(
                        children: [
                  ...
                  Column(
                    ...
                    children: [
                      Text(
                          "Services",
                          style: TextStyle(
                              fontFamily: "Metrisch-Bold",height: 1.8,fontSize: 22,color: Colors.white)
                      ),
                      SizedBox(height: 30,),
                      InkWell(
                        onHover: (x){
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 15,),
                      GradientButton(title: "Sign In",buttonwidth: 250,buttonheight: 50,),
    ...
    ):MediaQuery.of(context).size.width>844?Container(
      decoration: BoxDecoration(
        image: DecorationImage(
            image: AssetImage("assets/footerimg.png"),
            fit: BoxFit.fill
              ...
              children: [
                Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 10,),
                    Text(
                        "Terms of use | Privacy Environmental Policy",overflow: TextOverflow.ellipsis,style: TextStyle(
                        fontFamily: "Metrisch-Medium",height: 1.8, fontSize: 15,color: Colors.white)

                    ),
                    SizedBox(width: 50,),
                    Text(
                        "Copyright © 2021 Bennett University. All Rights Reserved.",overflow: TextOverflow.ellipsis,style: TextStyle(
                        fontFamily: "Metrisch-Medium",height: 1.8, fontSize: 15,color: Colors.white)
