        ...
        children: [
          Positioned(
            ...
            child: Text(
              "Learn",
              style: TextStyle(
                  fontFamily: "Metrisch-ExtraBold", color: Colors.white.withOpacity(0.1),fontSize: 120),
            ),
          ),
          Row(
        ...
        children: [
          Positioned(
            ...
            child: Text(
              "Learn",
              style: TextStyle(
                  fontFamily: "Metrisch-ExtraBold", color: Colors.white.withOpacity(0.1),fontSize: 150),
            ),
          ),
          Container(
