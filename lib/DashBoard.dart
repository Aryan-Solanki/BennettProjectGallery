                            ...
                            child: ListView.builder(
                              scrollDirection: Axis.horizontal,
                                ...
                                itemBuilder: (BuildContext ctxt, int index) {
                                  return Container(width: 250,margin: EdgeInsets.only(right: 20),padding: EdgeInsets.only(bottom: 40),child: ProjectCard());
                                },
                            ),
                          ),
                          SizedBox(height: 15,),
                                ...
                                return Container(
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      SizedBox(width: 30,),
                                      Container(
                                        width: MediaQuery.of(context).size.width>850?700:MediaQuery.of(context).size.width-150,
                                        child: Column(
                                          crossAxisAlignment: CrossAxisAlignment.start,
                                          children: [
